    ...
    return (
        ...
        <div className='footer-section'>
            ...
            <div className="footer-top">
                <svg className='down-arrow' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96 96" aria-hidden="true" focusable="false">
                ...
                <p className='title'>Etsy is powered by 100% renewable electricity.</p>
            </div>
            <div className="footer-mid-background">
                <div className="footer-mid">

                    <div className="footer-list-elements">
                        <List data={dataBase.shop}></List>
                        <List data={dataBase.sell}></List>
                        <List data={dataBase.about}></List>
                        <List data={dataBase.help}></List>
                    </div>

                    <div className="social-media">
                        <div className="download-etsy">
                            <div className='etsy-button'>
            ...
            <div className="footer-end-background">
