  ...
  return (
    <div className='header'>
        <div className="header-top">
            <svg className='etsy-logo' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 24" aria-hidden="true" focusable="false">
                    ...
                    DB.map((element,idx)=>(
                        <div key={idx} className="hover-effect">
                            <div className="element">
                                <List value={element.title}/>
                            </div>
                        </div>
                    ))
                }
                <div className="gift-header-wrapper">
